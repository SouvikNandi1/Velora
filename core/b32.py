__version__ = "1.0.1"
__description__ = "A fast Base32 encoder and decoder utility for encoding text directly from the command prompt."
__author__ = "Souvik"
__website__ = ""
...
def main():
    ...
    if len(args) < 2 or args[0] not in ('enc', 'dec'):
        print("\x1b[33mUsage:\x1b[0m b32 [enc|dec] <text>")
        return
    ...
    try:
        ...
        print(f"\x1b[31;1mError:\x1b[0m Invalid Base32 input.")
